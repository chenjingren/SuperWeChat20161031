...
public class SuperWeChatHelper {
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(String username) {
            ...
            Map<String, User> appLocalUsers = getAppContactList();
            if (!appLocalUsers.containsKey(username)){
                NetDao.reqAddContact(appContext,EMClient.getInstance().getCurrentUser() ,username, new OkHttpUtils.OnCompleteListener<String>() {
                    @Override
  ...
  public void addSyncGroupListener(DataSyncListener listener) {
   ...
   public void asyncFetchBlackListFromServer(final EMValueCallBack<List<String>> callback){
    ...
    public void setAppContactList(Map<String, User> aContactList) {
        if(aContactList == null){
            if (contactAppList != null || contactAppList.size()==0) {
